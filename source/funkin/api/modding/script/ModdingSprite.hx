package funkin.api.modding.script;


class ModdingSprite extends FlxSprite
{
	public var animOffsets:Map<String, Array<Float>> = new Map<String, Array<Float>>();
	public function new(?x:Float = 0, ?y:Float = 0, ?pixelObj:Bool = false)
	{
		super(x, y);
		antialiasing = !pixelObj && ClientPrefs.globalAntialiasing;
	}
